#!/usr/bin/env node
// tim-browser: visual regression against stored PNG baselines.
//
// Usage:
...
//
// Baselines live in .tim/visual-baselines/<sanitized-name>.png
// Diff images (if pixelmatch available) go to .tim/visual-baselines/<name>.diff.png
...
const BASELINE_DIR = path.join(process.cwd(), '.tim', 'visual-baselines');
